...
class SimpleClockGeneratorClass {
  public:
    ...
    void startPLLdivider(uint8_t pin, uint32_t ReferenceFrequency, uint32_t frequency);
    void writeDivider(uint8_t pin, uint16_t value);
    uint16_t readDivider(uint8_t pin);
    uint16_t readPrescaler(uint8_t pin);
    uint32_t readPLLfrequency(uint8_t pin, uint32_t ReferenceFrequency);
    void incrementDivider(uint8_t pin, uint16_t value);
    void decrementDivider(uint8_t pin, uint16_t value);
    void incrementPLLfrequency(uint8_t pin, uint32_t ReferenceFrequency, uint32_t value);
    void decrementPLLfrequency(uint8_t pin, uint32_t ReferenceFrequency, uint32_t value);
